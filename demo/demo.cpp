...
static auto description = "Demo";
static auto usage = "[-?|-h|--help] [--odf|-a] [--odi <int>] [--ods|-c <string>] [<flag>] [<int>] [<string>]";  // from Lyra backend

static auto programName = "HydrArgs demo";
