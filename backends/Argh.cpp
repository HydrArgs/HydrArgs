...
namespace HydrArgs::Backend{
	struct ArghBackend: public IBackendOwnStoredSpec, public PositionalParserIterative{
		...
		ArghBackend(const std::string &name, const std::string &descr, const std::string &usage [[maybe_unused]], std::vector<Arg*> dashedSpec, std::vector<Arg*> positionalSpec, Streams streams): IBackendOwnStoredSpec(dashedSpec, positionalSpec, streams), PositionalParserIterative(this), name(name), descr(descr), usage(usage){
		...
		inline argh::string_stream getNativeDashedArgType(Arg *argPtr){
	...
	IArgsParser *argsParserFactory(const std::string &name, const std::string &descr, const std::string &usage [[maybe_unused]], std::vector<Arg*> dashedSpec, std::vector<Arg*> positionalSpec, Streams streams){
		return new ArghBackend(name, descr, usage, dashedSpec, positionalSpec, streams);
	}
};
