...
namespace HydrArgs{
	...
	Arg::Arg(ArgType type, char letter, std::string name, std::string description, uint32_t minCount, const char *value_name, const char *value_unit): type(type), flags(flags), letterStr {letter, 0u}, name(name), description(description), minCount(minCount), value_name(value_name), value_unit(value_unit){}

	Arg::Arg(ArgType type, std::string name, std::string description, uint32_t minCount, const char *value_name, const char *value_unit): Arg(type, '\0', name, description, minCount, value_name, value_unit){}

	Arg::Arg(ArgType type, char letter, std::string name, std::string description, uint32_t minCount, const char *value_name): Arg(type, letter, name, description, minCount, value_name, nullptr){}

	Arg::Arg(ArgType type, std::string name, std::string description, uint32_t minCount, const char *value_name): Arg(type, name, description, minCount, value_name, nullptr){}

	Arg::Arg(ArgType type, char letter, std::string name, std::string description, uint32_t minCount): Arg(type, letter, name, description, minCount, nullptr){}

	Arg::Arg(ArgType type, std::string name, std::string description, uint32_t minCount): Arg(type, name, description, minCount, nullptr){}

	template struct SArg<ArgType::flag>;
	template struct SArg<ArgType::s4>;
	template struct SArg<ArgType::string>;

	PathArg::PathArg(char letter, std::string name, std::string description, uint32_t minCount, const char *value_name, const char *value_unit, StorageType defaultValue): SArg<ArgType::string>(ArgType::path, letter, name, description, minCount, value_name, value_unit, defaultValue){}
	PathArg::PathArg(std::string name, std::string description, uint32_t minCount, const char *value_name, const char *value_unit, StorageType defaultValue): SArg<ArgType::string>(ArgType::path, name, description, minCount, value_name, value_unit, defaultValue){}

	PathArg::PathArg(char letter, std::string name, std::string description, uint32_t minCount, const char *value_name, StorageType defaultValue): SArg<ArgType::string>(ArgType::path, letter, name, description, minCount, value_name, defaultValue){}
	PathArg::PathArg(std::string name, std::string description, uint32_t minCount, const char *value_name, StorageType defaultValue): SArg<ArgType::string>(ArgType::path, name, description, minCount, value_name, defaultValue){}

	PathArg::PathArg(char letter, std::string name, std::string description, uint32_t minCount, StorageType defaultValue): SArg<ArgType::string>(ArgType::path, letter, name, description, minCount, defaultValue){}
	PathArg::PathArg(std::string name, std::string description, uint32_t minCount, StorageType defaultValue): SArg<ArgType::string>(ArgType::path, name, description, minCount, defaultValue){}
	...
	IBackendOwnStoredSpec::IBackendOwnStoredSpec(std::vector<Arg *> dashedSpec, std::vector<Arg *> positionalSpec): IArgsParser(), dashedSpec(dashedSpec), positionalSpec(positionalSpec){}
	IBackendOwnStoredSpec::IBackendOwnStoredSpec(std::vector<Arg *> dashedSpec, std::vector<Arg *> positionalSpec, Streams streams): IArgsParser(streams), dashedSpec(dashedSpec), positionalSpec(positionalSpec){}
